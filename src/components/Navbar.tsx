          ...
          {isLoggedIn && (
            <>
              ...
              <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                ...
                >
                  <HomeOutlined className="mr-2 py-1 align-middle" />
                  Dashboard
                </button>
                <button
                ...
                >
                  <FundProjectionScreenOutlined className="mr-2 py-1 align-middle" />
                  Demo Day
                </button>
                <button
                  className="ml-8 whitespace-nowrap text-base font-medium text-black hover:text-gray-500"
                ...
                >
                  <UserOutlined className="mr-2 py-1 align-middle" />
                  Identity
                </button>
                <button
