...
const Onboard: React.FC<OnboardProps> = ({
    ...
    useEffect(() => {
        const updateProfile = async () => {
            try {
                ...
                // Direct to gameheads feed after successful response
                if (res.ok) {
                ...
                // Handle any errors unexpectedly occurring
    ...
    }, [profileData.full_name, profileData.bio, profileData.color1, profileData.color2, profileData.discord, profileData.level, profileData.notes, profileData.site, profileData.role1, profileData.role2, profileData.pronouns, profileData.queueColor, profileData.currentTeamId, profileData.currentTeamName, setCurrentPage, profileData]);
        ...
        ">
            ...
            ">
                ...
                <div className="flex flex-col gap-4 m-16 max-w-[320px]">
                    <PageIndicator currentStep={step} totalSteps={(Object.keys(STEPS).length / 2)} />
                    ...
                    <p className="text-body text-xs sm:text-sm">
                        GameheadsLabs is an official workspace to provide a space for a students and staff during the Summer Accelerator Program.
                    </p>
                    <Button
                        label={`Next`}
                        onClick={onNext}
            ...
            ">
                ...
                ">
                    ...
                    <div className="flex flex-col gap-4 m-16 max-w-[320px]">
                        ...
                        <p className="text-body text-xs sm:text-sm">
                            Users are verified Gameheads students because you were invited by someone on the platform!
                        </p>
            ...
            ">
                ...
                ">
                    ...
                    <div className="flex flex-col gap-4 m-16 max-w-[320px]">
                        ...
                        <p className="text-body text-xs sm:text-sm">
                            Adding your projects is as easy as 1-2-3 to showcase your projects and share with other Gameheads students across sites and the public as well!
                        </p>
                        <div className="flex flex-row gap-3">
                            <Button
                                label={`Back`}
                ...
                ">
                    <img
                        src='/graphics/intro2.png' // change to profile public graphic
                        alt="Intro 2 Backdrop"
                        style={{ maxWidth: '100%', height: 'auto' }}
                    />
                </div>
                ...
                <div className="flex-1 p-6 sm:p-12 overflow-y-auto">
                    ...
                    <div className="flex flex-col gap-7 max-w-[480px] mx-auto">
                        ...
                        >
                            {teams.map((item: any) => {
                                return (
                                    <Select.Option key={item.teamNum} value={item.teamName}>{item.teamName}</Select.Option>
                                )
                            })}
                        </Select>
